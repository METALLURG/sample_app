...
describe "Authentication" do
  ...
  describe "signin" do
    ...
    # Правильный тест на провальный вход (отлов бага flash)
...
# Тестирование того, что edit и update действия защищены
  describe "authorization" do

    describe "for non-signed-in users" do
      let(:user) { FactoryGirl.create(:user) }

      # Тест для дружелюбной переадресации
      ...
      # Тест для защиты действия destroy
